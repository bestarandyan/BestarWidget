package com.bestar.recyclerview;
...
import com.bestar.recyclerview.loadmore.DefaultLoadMoreView;
import com.bestar.recyclerview.util.PullToRefreshRecyclerViewUtil;
 ...
 */
public class BestarRecyclerView extends SwipeRefreshLayout implements PrvInterface {
...
//    private static final String TAG = "PTRRV";
    ...
    public BestarRecyclerView(Context context) {
        this(context,null);
    }

    public BestarRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.setup();
    }
...
//            lastVisibleItem = mLinearLayoutManager.findLastCompletelyVisibleItemPosition();
            ...
            if(mIsSwipeEnable) {
                if (findFirstCompletelyVisibleItemPosition() != 0) {
                    ...
                    BestarRecyclerView.this.setEnabled(false);
                } else {
                    BestarRecyclerView.this.setEnabled(true);
                }
            }
